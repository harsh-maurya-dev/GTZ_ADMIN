const ContractTempleteAdd = () => {
    return (
        <>
            <div className="mt-4 comman-design2">
                <div className="comman-design-header">
                    <h2 className="comman-heading">Contract Templete Add</h2>
                </div>
                            ...
                            <div className="col-6">
                                <div className="form-group">
                                    ...
                                    <div className="form-check form-switch">
                                        ...
                                        <label className="form-check-label mt-2 ms-3"
                                            htmlFor="flexSwitchCheckDefault">Requires Verification</label>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12">
...
export default ContractTempleteAdd
