                ...
                <div className="comman-design pb-0 light-list-blue">
                    <div className="d-flex justify-content-between">
                        <div className="d-flex gap-3">
                            <div className="">
                                <h2 className="comman-heading">Users Management</h2>
                                <span className="border rounded-pill py-1 px-3">4</span>
                            </div>
                            <div className="">
                                <Link to="/users_management_add" className="comman-btn">
            ...
            <div className="mt-4">
                <div className="comman-design2">
                    <div className="comman-design-header">
                        <h2 className="comman-heading">Users</h2>
                        <div className="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex justify-content-center gap-2 align-items-center">
                                                <Link to="/users_management_edit" className="table-icon bg-main">
