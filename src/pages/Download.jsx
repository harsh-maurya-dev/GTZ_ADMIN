                ...
                <div className="comman-design pb-0 light-list-blue">
                    <div className="d-flex justify-content-between">
                        <div className="d-flex gap-3">
                            <div>
                                <h2 className="comman-heading">Download Management</h2>
                                <span className="border rounded-pill py-1 px-3">1</span>
                            </div>
                            <div>
                                <Link to="/download_management_add" className="comman-btn">
                            ...
                            <table className="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>DX Trade</td>
                                        <td>Gooey Trade</td>
                                        <td>https://trade.gooeytrade.com</td>
                                        <td>
                                            <div className="d-flex gap-3 justify-content-center">
                                                <Link to="/download_management_edit" className="table-icon bg-main">
